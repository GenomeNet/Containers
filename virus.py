...
def run_podman(input_file, output_dir, use_gpu=False, batch_size=3000, level="binary", verbose=False):
...
if __name__ == "__main__":
    ...
    run_podman(args.input, args.output, args.gpu, args.batch_size, args.level, args.verbose)